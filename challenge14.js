...
var justNumbers = numberObjects.map(function(item) { // map porque passa por todos os item do array
    return item.number; // pega o valor de number, ou seja, os valores numéricos
});
...
var name = ['Ka', 'ro', 'li', 'na'];

var reduceName = name.reduce(function(acumulado, atual) {
...
var isArr = Array.isArray(justMod2Or3);
console.log(isArr)

if(isArr)
    console.log(String(justMod2Or3))
