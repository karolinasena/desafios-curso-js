...
(function () {
  ...
  */
  ...
  var replaceMyName = text.replace(/Manuel Marques de Sousa/, 'Karol');
  console.log(replaceMyName)
  ...
  */
  ...
  var replaceMyCity = text.replace(/brasileiro/, 'aracatiense');
  console.log(replaceMyCity)
  ...
  */
  ...
  var replaceNumbers = text.replace(/\d/g, '-')
  ...
  */
  ...
  var replaceLetras = text.replace(/[D-Hd-h]/g, '0');
  console.log(replaceLetras)
  ...
  */
  ...
  var replaceLetraA = text.replace(/[Aa]/g, '4')
  console.log(replaceLetraA)
  ...
  */
  ...
  var frase = "O Centauro de Luvas";
  var replaceFrase = text.replace(/O Centauro de Luvas/g , function(letra) {
