(function () {
  ...
  */
  var a = 2, b = 3;
  console.log('O resultado da soma é:', sum(a, b)(function () {
    return a + b;
  }));
  ...
  */
  var subtraction = calculator(a, b);
  var multiplication = calculator(a, b);
  var division = calculator(a, b);
  var mod = calculator(a, b);
  ...
  */
  ...
  console.log('O resultado da divisão é:', subtraction(function () {
    return a / b;
  }));
